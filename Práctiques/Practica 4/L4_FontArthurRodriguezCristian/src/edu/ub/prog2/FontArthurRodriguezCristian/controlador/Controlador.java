...
public class Controlador implements InControlador {
    ...
    public void reproduirFitxer(int id) throws AplicacioException {
        ...
        this.escoltador.iniciarReproduccio(cp, dada.isReproduccioCiclica(), dada.isReproduccioAleatoria());
    }
    ...
    public void reproduirCarpeta() throws AplicacioException {
        this.escoltador.iniciarReproduccio(this.dada.getBiblio(), dada.isReproduccioCiclica(), dada.isReproduccioAleatoria());
    }
    ...
    public void reproduirCarpeta(String titolAlbum) throws AplicacioException {
        this.escoltador.iniciarReproduccio(this.dada.getAlbum(titolAlbum), dada.isReproduccioCiclica(), dada.isReproduccioAleatoria());
    }
    ...
    public void setAleatori () {
        if (this.dada.isReproduccioAleatoria()){
            this.dada.setReproduccioAleatoria(false);
        }else{
            this.dada.setReproduccioAleatoria(true);
        }
    }
    
    public boolean isCiclic() {
        return this.dada.isReproduccioCiclica();
    }
    ...
    public void setCiclica () {
        if (this.dada.isReproduccioCiclica()){
            this.dada.setReproduccioCiclica(false);
        }else{
            this.dada.setReproduccioCiclica(true);
        }
    }
     ...
     */
    public void setReprodutor() throws AplicacioException {
